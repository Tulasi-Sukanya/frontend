...
function Slidenavbarcontent(){
  const [slide, setSlide] = useState("First");
    ...
    return(
        <div>
          <div id="sub-nav">
          <li className="hover-effect-child1" style={{fontWeight:"600"}} onClick={() => setSlide("First")}> GUIDED PROGRAM</li>
          <li className="hover-effect-child1" style={{fontWeight:"600"}} onClick={() => setSlide("Second")}> DOUBT RESOLUTION</li>
          <li className="hover-effect-child1" style={{fontWeight:"600"}} onClick={() => setSlide("Third")}> CODING NIJAS STUDIO </li>
          <li className="hover-effect-child1" style={{fontWeight:"600"}} onClick={() => setSlide("Fourth")}>MOCK INTERVIEW</li>
          <li className="hover-effect-child1" style={{fontWeight:"600"}} onClick={() => setSlide("Five")}> PLACEMENT CELL</li>
          <li className="hover-effect-child1" style={{fontWeight:"600"}} onClick={() => setSlide("Six")} > FREE RESOURCES</li>
          </div>
