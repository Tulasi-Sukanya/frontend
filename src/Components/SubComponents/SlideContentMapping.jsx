...
function SlideContentMapping(){
  const [slide, setSlide] = useState("First");
    ...
    return(
        <div>
              <div id="sub-nav-page">
          <li className="hover-effect-child1" onClick={() => setSlide("First")}>GUIDED PROGRAM</li>
          {slide === "First" && (
          <Slide
          ...
          <li className="hover-effect-child1" onClick={() => setSlide("Second")}>DOUBT RESOLUTION</li>
          {slide === "Second" && (
          <Slide
...
We have a network of dedicated teaching assistants to make sure your doubts get resolved quickly and you dont miss on deadlines."
          ...
          <li className="hover-effect-child1" onClick={() => setSlide("Third")}>CODING NIJAS STUDIO</li>
          {slide === "Third" && (
          <Slide
          ...
          <li className="hover-effect-child1" onClick={() => setSlide("Fourth")}>MOCK INTERVIEW</li>
          {slide === "Fourth" && (
          <Slide
          ...
          <li className="hover-effect-child1" onClick={() => setSlide("Five")}>PLACEMENT CELL</li>
          {slide === "Five" && (
          <Slide
          ...
          <li className="hover-effect-child1" onClick={() => setSlide("Six")}>FREE RESOURCES</li>
          {slide === "Six" && (
          <Slide
...
export default SlideContentMapping;